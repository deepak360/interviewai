...
export default function InterviewPage() {
  ...
  // reattach stream whenever video element mounts
  ...
  function handleNext(skipped = false) {
    ...
    if (!skipped) {
      setTranscripts(prev => ({ ...prev, [q.id]: transcript }))
    }
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-4">
      <div className="bg-gray-800 rounded-2xl p-8 max-w-md w-full text-white text-center">
        ...
        <p className="text-gray-400 text-sm mb-2">
          You answered {Object.keys(transcripts).length} of {questions.length} questions.
        </p>
        <p className="text-gray-500 text-xs mb-6">Scoring and debrief coming in Phase 3.</p>
      ...
      <div className="flex flex-1 gap-6 p-6 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <div className="bg-gray-800 rounded-2xl p-6 flex-1 overflow-y-auto">
            ...
            {stage === 'answer' && (
              <div className="mt-6">
                <p className="text-xs text-gray-400 mb-2">Your answer (live transcript)</p>
          ...
          <div className="mt-4 flex gap-3">
            {stage === 'question' && (
              <>
                <button
                  onClick={() => speak(q.question, startAnswer)}
              ...
              {questions.map((_, i) => (
                <div
                  ...
                  className={`w-3 h-3 rounded-full ${
                    ...
                    : i === current ? 'bg-blue-500 animate-pulse'
                    : 'bg-gray-600'
                  }`}
                />
              ))}
